...
//  
//
//  Created by Rory O'Connor on 11/10/17.
//
	...
	while (opt != QUIT) {
		switch (opt) {
			...
			case REMOVE_INFORMATION:
				...
				printf("\n\tRemoving the informational item '%s' from the contact %s\n", 
...
void optionDetails(void) {
	...
	printf("\tremoveInformation      Remove an information item from a contact\n");
